...
pub const SCRAPING_ETH_LOGS_INTERVAL: Duration = Duration::from_secs(1 * 30); // 3 * 60
pub const PROCESS_ETH_RETRIEVE_TRANSACTIONS_INTERVAL: Duration = Duration::from_secs(1 * 30); // 6 * 60
