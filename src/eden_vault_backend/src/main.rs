...
use eden_vault_backend::ledger_client::{LedgerBurnError, LedgerClient};
    ...
    if req.path() == "/metrics" {
        ...
        fn encode_metrics(w: &mut MetricsEncoder<Vec<u8>>) -> std::io::Result<()> {
            ...
            read_state(|s| {
                ...
                eden_vault_backend::eth_rpc::encode_metrics(w)?;
        ...
        use eden_vault_backend::logs::{Log, Priority, Sort};
        use std::str::FromStr;
