...
cast send $EDEN_TOKEN_ADDRESS \
    ...
    --gas-limit 65000 \
    "approve(address,uint256)" "$CK_ERC20_DEPOSIT_ADDRESS" "10000000"
...
cast send $CK_ERC20_DEPOSIT_ADDRESS \
    ...
    --private-key $ALICE_PRIVATE_KEY \
    --gas-limit 75000 \
    "deposit(address,uint256,bytes32)" "$EDEN_TOKEN_ADDRESS" "10000000" "1d940617d68b8399fbda054af51624e768f7378d1ec0d890279a61a460020000"
